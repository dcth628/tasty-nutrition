...
recipe_2 = Recipe(
    ...
    instruction='1.Place the strawberries in a large pot or saucepan and mash them slightly with a potato masher or fork to release their juices.\n2.Add the sugar and lemon juice to the pot and stir well to combine.\n3.Once the jam has thickened, remove the pot from heat and skim off any foam that may have formed on the surface.',
    serving=5,
    cooktime=45,
    user_id=1,
)
...
recipe_3 = Recipe(
    ...
    instruction='1.Rinse the spinach leaves thoroughly under cold water to remove any dirt or debris. Pat them dry or use a salad spinner to remove excess moisture.\n2.Heat olive oil in a large skillet or pan over medium heat.\n3.Add the minced garlic to the pan and sauté for about 1 minute until fragrant, being careful not to burn it.',
    serving=2,
    cooktime=25,
    user_id=2,
)
...
recipe_4 = Recipe(
    ...
    instruction='1.In a saucepan, combine the rolled oats, water or milk, and a pinch of salt.\n2.Place the saucepan over medium heat and bring the mixture to a gentle boil.\n3.Reduce the heat to low and simmer the oatmeal, stirring occasionally, for about 5 to 7 minutes or until it reaches your desired consistency. If you prefer a thicker oatmeal, cook it for a bit longer.',
    serving=2,
    cooktime=15,
    user_id=3,
)
...
recipe_5 = Recipe(
    ...
    instruction='1.In a food processor, combine the flour, grated cheddar cheese, salt, and paprika (if using). Pulse a few times to mix the ingredients.\n2.Add the cold butter pieces to the food processor and pulse until the mixture resembles coarse crumbs.\n3.Gradually add the ice water, one tablespoon at a time, while pulsing the food processor. Continue until the dough comes together and forms a ball. You may not need to use all of the water.',
    serving=1,
    cooktime=10,
    user_id=1,
)
